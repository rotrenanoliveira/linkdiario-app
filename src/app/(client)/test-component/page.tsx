        ...
        <div className="flex-1 space-y-4 lg:space-y-8">
          ...
          <div className="font-light text-foreground space-y-3 lg:space-y-6 xl:space-y-9">
            ...
            <p className="text-sm md:text-lg xl:text-xl">
              O linkdiario é uma ferramenta de criação de Presell projetada para impulsionar suas vendas online de forma
            ...
            <p className="text-sm md:text-lg xl:text-xl">
              Sabemos que criar campanhas envolventes pode ser desafiador. O linkdiario é a solução que simplifica esse
              processo, permitindo que você alcance resultados expressivos com agilidade.
            </p>
