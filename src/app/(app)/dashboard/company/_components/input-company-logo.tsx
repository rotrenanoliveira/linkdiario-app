...
export function InputCompanyLogo() {
  ...
  return (
    <>
      <div className="w-full lg:w-auto flex space-x-4">
        <div className="w-1/2 lg:w-1/4 space-y-2">
          <Label
          ...
          >
            <div className="size-20 flex items-center justify-center rounded-full bg-zinc-100 transition-all duration-150 hover:bg-zinc-200">
              <Upload size={24} />
            </div>
